<?php
    ...
    if(isset($_POST['remover_admin'])){   //Caso o administrador tenha clicado no botão para remover outro administrador

        $id_remover = $_POST['ID_REMOVER'];     //Guardar o ID de utilizador do administrador
        ...
        if ($result && $result1) {     //Caso o administrador seja removido
            //-----------------------------------------------------------------------------
            // Enviar email a informar o administrador que a sua conta foi removida
            //-----------------------------------------------------------------------------
            ...
            header("Location: /projeto/admin/admin/remover_admin.php?success= Admin removido!");     //Mensagem de sucesso
            exit();
        }
        else{       //Caso contrário
            header("Location: /projeto/admin/admin/remover_admin.php?error= Erro!");    //Mensagem de erro
            exit();
        }
    }
    else{

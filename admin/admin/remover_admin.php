...
if (isset($_SESSION['USERNAME']) && isset($_SESSION['ID_UTENTE']) === FALSE && isset($_SESSION['ID_MEDICO']) === FALSE) {
    ...
    $sql = "SELECT utilizador.ID_UTILIZADOR, utilizador.USERNAME, utilizador.NOME_COMPLETO, utilizador.EMAIL FROM utilizador WHERE utilizador.TIPO=3";
...
<html>
    ...
    <body id="body">
        ...
        <!----------------------------------------------------------
        // Pop-Up a informar que o administrador vai ser removido
        ----------------------------------------------------------->
                ...
                <div class="modal-content">
                    ...
                    <form action="remover.php" method="POST">
                        <div class="modal-body">
                            ...
                            <p>O admin vai ser removido!</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Não</button>
                            <button type="submit" name="remover_admin" class="btn btn-primary">Sim</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!-----------------------------------------------------------------
        // Pop-Up a informar que o administrador foi removido com sucesso
        ------------------------------------------------------------------>
        ...
        <section class="shadow-sm mx-auto w-75 shadow clearfix my-5 rounded bg-white p-5 resize">
            ...
            <h4><i class="fa fa-cog" aria-hidden="true"></i> Remover Admins</h4>
            <hr class="my-4">
...
<script>
    $(document).ready( function(){
        $('.remover_btn').on('click', function(){      //Caso tenha sido clicado o botão para remover um administrador
...
<script>
    $("#myModal").on('hidden.bs.modal', function () {          //Caso o pop-up seja fechado
        window.location.href = '/projeto/admin/admin/remover_admin.php';       //Atualizar a página
    });

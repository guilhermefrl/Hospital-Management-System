<?php
    ...
    if(isset($_POST['s_cancelar'])){            //Caso o utente tenha clicado no botão para cancelar uma consulta
        ...
        if($result){    //Caso não tenha ocorrido nenhum erro
            header("Location: /projeto/utente/consultas/cancelar_consultas.php?success= Consulta cancelada!");  //Mensagem de sucesso
        }
    }

<?php
    ...
    if(isset($_POST['eliminar_utilizador'])){   //Caso o utente tenha clicado no botão para eliminar a sua conta

        $id_remover = $_POST['id'];     //Guardar o ID de utilizador do utente
        ...
        if ($result8) {     //Caso o utente seja eliminado
            //-----------------------------------------------------------------------------
            // Enviar email a informar o utente que a sua conta foi eliminada com sucesso
            //-----------------------------------------------------------------------------
